      ...
      <div class="wrapper">
        ...
        <header class="main-header">
          ...
          <a href="#" class="logo">
            ...
            <span class="logo-lg"><b> SIIASI </b></span>
          </a>
          ...
          <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li  class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('notafiltro1')}}" ><i class="fa fa-circle-o"></i>Notas informativas </a></li>  
                    <li><a href="{{route('redesfiltro1')}}"><i class="fa fa-circle-o"></i>Redes sociales     </a></li>  
                </ul>
                @endif
              </li>
        ...
        <footer class="main-footer">
          <strong>
          Copyright &copy;. Derechos reservados. Secretaría de Desarrollo Social - UDITI.  
          </strong>
        </footer>
      </div>
      <!-- jQuery 3 -->
