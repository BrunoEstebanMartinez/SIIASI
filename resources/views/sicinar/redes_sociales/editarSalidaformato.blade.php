            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarsalidaformato',$regremision->folio], 'method' => 'PUT', 'id' => 'actualizarsalidaformato', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">   
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\remision1Request','#actualizarsalidaformato') !!}
@endsection
