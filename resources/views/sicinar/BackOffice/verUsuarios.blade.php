                            ...
                            <table id="tabla1" border="1" style="border: 2px solid slategray;" class="table table-bordered table-sm">
                                <thead style="border-color:brown;color: brown;" class="justify">
                                    <tr> 
                                        ...
                                        <th colspan="1" style="text-align:left; vertical-align: middle;border: 2px solid slategray;"><b style="color: dodgerblue">Clave <br>S.P.</b>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left; vertical-align:middle;">
                                            @foreach($reguadmon as $depen)
                                                @if($depen->uadmon_id == $usuario->depen_id)
                                                    {{$depen->uadmon_id.' '.Trim($depen->uadmon_desc)}}
                                                    @break
                                                @endif
                                            @endforeach 
                                        </td>
                                        ...
                                        <td style="text-align:left; vertical-align: middle;">{{$usuario->cve_arbol}}</td>
