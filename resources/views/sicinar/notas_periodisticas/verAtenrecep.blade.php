...
@section('title','Ver gestión interna - seguimiento')
...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Gestión interna - Seguimiento -  
                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="page-header" style="text-align:right;">
                            ...
                            {{ Form::open(['route' => 'buscaratenrecep', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                            ...
                            <table id="tabla1" class="table table-hover table-striped">
                                <thead style="color: brown;" class="justify">
                                    <tr>
                                        ...
                                        <th style="text-align:left;  vertical-align: middle;font-size:11px;">PDF <br>Segmto.  </th>                                        
                                        <th style="text-align:left;  vertical-align: middle;font-size:11px;">St.              </th>                                          
                                        
                                        <th style="text-align:center;vertical-align: middle;font-size:11px; width:100px;">Seguimiento </th>
                                    </tr>
                                </thead> 
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if( !empty(Trim($recep->ent_arc2))&&(!is_null(trim($recep->ent_arc2))) )
                                            <td style="color:darkgreen;text-align:center; vertical-align:middle;font-size:11px;" title="Documento de seguimiento">
                                                <a href="/storage/{{$recep->ent_arc2}}" class="btn btn-danger" title="Oficio digital"><i class="fa fa-file-pdf-o"></i>
                                                </a>
                                                <a href="{{route('editaratenrecep2',$recep->folio)}}" class="btn badge-warning" title="Editar documento de seguimiento"><i class="fa fa-edit"></i></a>
                                            </td>
                                        @else
                                            <td style="color:darkred; text-align:center; vertical-align: middle;font-size:11px;" title="documento de seguimiento"><i class="fa fa-times"></i>
                                                <a href="{{route('editaratenrecep2',$recep->folio)}}" class="btn badge-warning" title="Editar documento de seguimiento"><i class="fa fa-edit"></i></a>
                                            </td> 
                                        @endif    
                                        ...
                                        <td style="text-align:center;">
                                            <a href="{{route('editaratenrecep',$recep->folio)}}" class="btn badge-warning" title="Seguimiento"><i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
