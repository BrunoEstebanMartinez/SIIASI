            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizaratenrecep',$regrespuesta->folio], 'method' => 'PUT', 'id' => 'actualizaratenrecep', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">   
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="row">    
                                        <label>Fecha de seguimiento </label><br>
                                        <div class="col-xs-4 form-group">
                                        <label > Año </label>
                                        <select class="form-control m-bot15" name="periodo_id3" id="periodo_id3" required>
                                        <option selected="true" disabled="disabled">Seleccionar año </option>
                                        @foreach($regperiodos as $anio)
                                            @if($anio->periodo_id == $regrespuesta->periodo_id3)
                                        ...
                                        <div class="col-xs-3 form-group">
                                        <label >Mes </label>
                                        <select class="form-control m-bot15" name="mes_id3" id="mes_id3" required>
                                        <option selected="true" disabled="disabled">Seleccionar mes</option>
                                        @foreach($regmeses as $mes)
                                            @if($mes->mes_id == $regrespuesta->mes_id3)
                                        ...
                                        <div class="col-xs-3 form-group">
                                        <label >Día </label>
                                        <select class="form-control m-bot15" name="dia_id3" id="dia_id3" required>
                                        <option selected="true" disabled="disabled">Seleccionar día</option>
                                        @foreach($regdias as $dia)
                                            @if($dia->dia_id == $regrespuesta->dia_id3)
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                            <label>Resumen de seguimiento </label>
                                    ...
                                    <div class="col-xs-4 form-group">                        
                                        <label>Estado de atención del documento  </label>
                                        <select class="form-control m-bot15" name="ent_status2" id="ent_status2" required>
                                            @if($regrespuesta->ent_status2 === '0')
                                                <option value="0" selected>Pendiente  </option>
                                                <option value="1">         En proceso </option>
                                                <option value="2">         Atendido   </option>
                                            @else
                                                @if($regrespuesta->ent_status2 === '1')                                        
                                                    <option value="0">         Pendiente  </option>
                                                    <option value="1" selected>En proceso </option>
                                                    <option value="2">         Atendido   </option>
                                                @else
                                                    @if($regrespuesta->ent_status2 === '2')      
                                                        <option value="0">         Pendiente  </option>
                                                        <option value="1">         En proceso </option>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 form-group">
                                            ...
                                            <textarea class="form-control" name="ent_obs2" id="ent_obs2" rows="2" cols="120" placeholder="Asunto 4,000 caracteres" required>{{Trim($regrespuesta->ent_obs2)}}
                                            </textarea>
                                        </div>                                
                                    </div>    
                                    ...
                                    <div class="row">               
                                        <div class="col-xs-6 form-group">
                                            <label >Archivo digital PDF de seguimiento </label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\atenrecepRequest','#actualizaratenrep') !!}
@endsection
