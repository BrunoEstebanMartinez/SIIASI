...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Menú
                <small> Estadísticas - Notas informativas</small>                
            </h1>
        </section>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => 'estadisticanota', 'method' => 'POST','id' => 'estadisticanota', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">    
                                <div class="col-xs-2 form-group"> 
                                    ...
                                    <option value="1">Medios informativos  </option>
                                    <option value="2">Tipos de notas informativas  </option>
                                    <option value="3">Calificación         </option>
                                    </select>
                                </div>
                            </div>                     
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\filtronota1Request','#estadisticanota') !!}
@endsection
