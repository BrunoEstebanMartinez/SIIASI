...
@section('title','Estadística por tipo de red social')
                        ...
                        <table id="tabla1" class="table table-striped table-bordered table-sm">
                          <thead style="color: brown;" class="justify">
                            <tr>
                              ...
                              <th rowspan="2" style="text-align:left;"  >RED SOCIAL </th>
                          ...
                          <tbody>
                            ...
                            @foreach($regnotaredesd as $nota)
                              ...
                              <tr>
                                <td style="color:darkgreen;">{{$nota->rs_id}}</td>
                                <td style="color:darkgreen;">{{$nota->rs_desc}}   </td>
...
@section('javascrpt')
  ...
  <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ['Medio informativo', 'Total'],
          @foreach($regnotaredesd as $nota)
             ['{{$nota->rs_desc}}', {{$nota->total}} ],
          @endforeach          
        ]);
        ...
        var options = {
          ...
          chart: { title: 'Numeralia básica',
                   subtitle: 'Gráfica por medio informativo' },
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          @foreach($regnotaredesd as $tipogasto)
             ['{{$tipogasto->rs_desc}}', {{$tipogasto->total}} ],
          @endforeach
          //['Work',     11],
          //['Eat',      2],
          //['Commute',  2],
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          @foreach($regnotaredesd as $tmes)
             ['{{$tmes->rs_desc}}', {{$tmes->total}} ],
          @endforeach          
        ]);

        var options = {                 
          title: 'Por tipo de red social',
          width:  400,                // Alto de la pantalla horizontal
          height: 400,               // Ancho de la pantalla '75%',
          colors: ['green'],          // Naranja #e7711c
          legend: { position: 'none' },
          chart: { title: 'Gráfica  ',
                   subtitle: 'Por red social' },
          bars: 'horizontal',         // Required for Material Bar Charts.
          axes: {
            x: {
              0: { side: 'top', label: 'total'} // Top x-axis.
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Gráfica por medio informativo',
          pieHole: 0.4,
          width: 500,                   // Ancho de la pantalla horizontal
          height: 300,                  // Alto de la pantall '75%',
        };
