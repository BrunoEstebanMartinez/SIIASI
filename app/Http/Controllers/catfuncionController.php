...
class catfuncionController extends Controller
{
    ...
    public function actionVerFuncion(){
        ...
        $regfuncion = regFuncionModel::join('OFIPA_CAT_PROCESOS','OFIPA_CAT_PROCESOS.PROCESO_ID','=','OFIPA_CAT_FUNCIONES.PROCESO_ID')
